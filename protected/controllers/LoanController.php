    ...
    public function actionCreate() {
        ...
        if (isset($_POST['Loan'])) {
            ...
            if ($model->save()) {
                ...
                $subject = '=?UTF-8?B?' . base64_encode('Apply New Loan : ' . $model->name) . '?=';
                ...
                Yii::app()->user->setFlash('loan', 'Thank you for contacting us. We will respond to you as soon as possible.');
                $this->refresh();
            }
